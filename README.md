<h1 id="title">ReadMe file for "A Unique Empoloyee Payroll Tracker"</h1><img src = "https://badgen.net/badge/license/MIT">
...
<p>Follow link below to deployed Website, press the only button on the body of the page, and follow all prompts.</p>
