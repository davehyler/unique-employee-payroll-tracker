...
const displayAverageSalary = function(employeesArray) {
  ...
  let averageSalary = (total/employeesArray.length).toLocaleString();
  console.log(`The AVERAGE SALARY of our ${employeesArray.length} employee(s) is ${averageSalary}`);
  //add redundant average line so that the end-user does not need to open the console to idenfity the average salary
  alert(`The AVERAGE SALARY of our ${employeesArray.length} employee(s) is ${averageSalary}`);
}
